...
se puede usar la mediana de la distribución, $\hat{\sigma}_t = \mbox{mediana}\{ y_{t + 23 \cdot k } \mid k=0,1,\ldots,23\}$, $t=1,\ldots,L$.
...
respectivamente, y escribamos $\hat{y}_i=[\bs{X}\hat{\bs{\beta}}][i]$ y $\hat{y}_i^\ast=[\bs{X}\,\hat{\bs{\beta}}^\ast][i]$
