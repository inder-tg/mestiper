...
$h$ observaciones tanto a la izquierda como a la derecha de $y_t$.
...
de banda, es decir, $c_k = 1/(2h+1)$. En una nota posterior veremos que las
...
tiempo es utilizando _regresión no-paramétrica_. En una sección posterior
ahondaremos en esta clase de modelos estadísticos. Por ahora, sólo
presentaremos un ejemplo de regresión no-paramétrica: LOWESS (Robust locally
...
Antes de pasar a los ejemplos debemos notar que la distribución de 
probabilidades de $S_n$ es complicada de establecer; existen tablas para 
$n\leq 10$. Para valores grandes de $n$, sin embargo, hacemos uso de la siguiente 
...
$p$-valor de $3.9\times 10^{-9}$ por lo cual rechazamos **contundentemente**
...
(en mg/l) y la descarga promedio (en $m^3$) desde 1965 hasta 2009. Aquí nos
concentraremos en la concentración de sedimentos.
...
un decrecimiento en la concetración de sedimentos desde 1965 hasta 2009. Usamos
...
y $(j, Y_j)$ está dado por
\[
  b_{i,j}
  =
  \frac{Y_j - Y_i}{j-i}.
\]
Nota que $b_{i,j}$ es una cantidad aleatoria, ya que $Y_i$ y $Y_j$ son aleatorios,
