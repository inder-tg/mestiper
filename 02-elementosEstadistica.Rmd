...
el 5% opta por este número. La psicología tiene hipótesis para explicar este fenómeno,
...
en este estudio de simulación concluimos que quien tenga interés en completar
una colección de las tarjetas de cereales _Buendía_ necesitará comprar una mediana
de 6 cajas -pero puede necesitar comprar más.
...
<div class="centered">
  ...
  evento. Denotemos con la letra $\tetxbf{A}$ cualquier evento de interés, entonces
  \[
    \mbox{P}\{ A \} 
    = 
...
<div class="centered">
  ![Figura 4. Teorema del Límite Central.](figs/CLT.png){width=50%, height=35%}
</div>
...
a muchas de las bases de datos que llegan a nuestras manos? La respuesta radica 
en el hecho que cuando el tamaño de la muestra aumenta entonces la
distribución de probabilidades del promedio aritmético se aproxima a la mundialmente
famosa _curva de Gauss_. Esta curva de Gauss es propiamente, en el mundo matemático,
...
como _la probabilidad que la normal estándar sea menor que_ $q_z$. Matemáticamente
...
ya podemos comenzar a discutir los temas de este capítulo: pruebas de hipótesis
...
$\mathbf{Ber}(p)$ efectuado por la $i$-\'esima persona, entonces
$X_1+X_2+\cdots+X_i$ representa el n\'umero de cartas rojas extraidas por las
...
no parece falsa. Formalmente, **fallamos en rechazar** la hipótesis. Sí,
es una aseveración débil pero es lo que hay.
...
realidad no son tan extraordinarios como aparentan. Si ustedes creen en datos más
que en supuestos, entonces, dada esa opcián, deberían rechazar la hipótesis.
...
Si comparamos este $p$-valor con el canónico nivel de significancia 0.05, podemos concluir
...
y hemos observados algo (datos) realmente sorprendente, o bien
...
En (https://www.youtube.com/watch?v=aGHkIqQGtXA)[YouTube] es posible encontrar
