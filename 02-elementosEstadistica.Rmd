...
## Prueba de hipótesis y p-valor {#test}
...
En nuestro ejemplo tenemos que $n=25$, $\mu=0.5$ y $\sigma^2=0.25$ por lo cual
...
dado que la hipótesis de trabajo es verdadera. Esta probabilidad se conoce como **$p$-valor**.
...
parece una aseveración débil pero a la luz de los datos podemos estar convencidos
que nuestra aseveración es correcta.
...
la hipótesis nula recibe el nombre de _hipótesis alternativa_. Así, para nuestro
ejemplo, podemos escribir la hipótesis alternativa usando los símbolos
$H_a: \rho\neq0$.
...
_muestral_ de $\rho$, en símbolos, $\widehat{\rho}$.^[El símbolo $\widehat{\rho}$ se lee
como _rho gorrito_.]
